...
<img width="1687" alt="eBPF安全开发与攻防对抗系列课程 - 非虫" src="https://github.com/feicong/ebpf-course/assets/1672927/2e099678-8171-4449-bfb4-c945222484b9">
...
课程目录目前设计了第一与第二两季。**后续可能的第三季的计划，可以见下面视频介绍第7分钟处！**
...
**eBPF的学习过程中需要用到eBPF环境，您可以选择课程中提供的虚拟机与模拟器环境完成多数的基础学习，但eBPF的完整特性学习建议购买设备。**

99新配置好内容的redmi note 11t pro手机一台（8g/128g）。价格**1399**元。

开发板orangepi 5plus 16g+512g ssd+原装电源+外壳风扇+wifi6网卡+网线与螺丝工具，以及配套的配置文档。价格**1665**元。

开发板nanopc t6 16g+512g ssd+原装电源+原装外壳+wifi6网卡+网线与螺丝工具，以及配套的配置文档。价格**1765**元。

开发板rock5b 16g+512g ssd+pw65w电源+外壳风扇+wifi6网卡+网线与螺丝工具，价格**1965**元。

迷你电脑ser5pro 5800h一台，已经配置好Linux与安卓模拟器的eBPF开发环境，可作为课程观看设备，开箱即用！价格**2265**元。

## 课程活动

**从今天起，购买eBPF全季课程的新老学员，都送免费的 strong-frida工具。该工具用于过掉目前市面上主流的Frida检测！**

## 说明

eBPF系列课程目录全公开，在不影响承诺内容前提下实时调整。目前第5季已确定计划制作，内容为eBPF其它在新版本内核中所有涉及到的特性以及云原生相关的内容。
