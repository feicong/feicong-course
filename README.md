...
课程播放可以使用**Windows/macOS/Android手机/iOS手机或平板设备**，课程实验环境可以选择安装Ubuntu24.04系统的虚拟机，或者另外准备好一台安装好Ubuntu24.04系统的电脑也可。
...
** 课程购买直接联系本人微信**feicongcn**购买，课程的播放需要微信绑定设备授权，支持Windows/macOS/Android/iOS设备播放**


### 课程配套学习设备购买

**学习过程中用到eBPF开发与系统定制的运行环境，可以选择课程中提供的虚拟机与模拟器环境完成多数的基础学习，也可以淘宝购买Pixel6设备Root后学习实践。**
